...
public class HoloLens2DA : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        tex_pv = new Texture2D[2];

        tex_pv[0] = new Texture2D(pvcf.width, pvcf.height, TextureFormat.BGRA32, false);
        tex_pv[1] = new Texture2D(pvcf.width, pvcf.height, TextureFormat.BGRA32, false);
        ...
        pv_image[0].GetComponent<Renderer>().material.mainTexture = tex_pv[0];
        pv_image[1].GetComponent<Renderer>().material.mainTexture = tex_pv[1];
    ...
    void Update_PV(hl2da_framebuffer fb)
    {
        ...
        */
        ...
        // {
        //     GameObject pv_image_object = pv_image[index];
        //     pv_image_object.GetComponent<Renderer>().material.mainTexture = tex_pv[index];

        //     Vector3 localScale = pv_image_object.transform.localScale;
        //     localScale.x = -1;
        //     pv_image_object.transform.localScale = localScale;
        // }
