Shader "Custom/SuperSampled Texture"
{
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma multi_compile _ _SUPERSAMPLING_2X2_RGSS _SUPERSAMPLING_8X_HALTON _SUPERSAMPLING_16X16_OGSS
            ...
            struct v2f {
                ...
                UNITY_VERTEX_OUTPUT_STEREO // Handle stereo output
            };

            void vert(appdata_base v, out v2f o)
            {
                UNITY_SETUP_INSTANCE_ID(v); // Set up instance ID
                UNITY_INITIALIZE_OUTPUT(v2f, o); // Initialize the vertex output structure
